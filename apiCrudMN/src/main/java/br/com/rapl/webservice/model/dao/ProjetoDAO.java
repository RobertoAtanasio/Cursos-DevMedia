...
import br.com.rapl.webservice.exceptions.DAOException;
import br.com.rapl.webservice.exceptions.ErrorCode;
...
public class ProjetoDAO {
    ...
    public Projeto update(Projeto projeto) {
        ...
        try {
            ...
            em.getTransaction().rollback();
            throw new DAOException("Projeto informado para atualizaçã£o não existe: " + ex.getMessage(), ErrorCode.NOT_FOUND.getCode());
        } catch (RuntimeException ex) {
            em.getTransaction().rollback();
    ...
    public Projeto delete(long id) {
        ...
        try {
            ...
            em.getTransaction().rollback();
            throw new DAOException("Projeto informado para remoção não existe: " + ex.getMessage(), ErrorCode.NOT_FOUND.getCode());
        } catch (RuntimeException ex) {
            em.getTransaction().rollback();
